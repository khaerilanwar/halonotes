...
<?php
// var_dump($errorMessage['nama']);
// dd(session()->getFlashdata('errorInput'));
$errorMessage = ['nama' => null, 'username' => null, 'password' => null, 'repassword' => null];
...
<section class="bg-slate-300 dark:bg-gray-900 md:pt-8">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
        ...
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="/daftar/save" method="post">
                    <?= csrf_field(); ?>

                    <div class="mb-6">
                        <label for="nama" class="block mb-2 text-sm font-medium <?= ($errorMessage['nama']) ? 'text-red-700 dark:text-red-500' : 'text-gray-900 dark:text-white'; ?>">Nama Lengkap</label>
                        <input type="text" name="nama" value="<?= old('nama'); ?>" id="nama" class="<?= ($errorMessage['nama']) ? 'bg-red-50 border border-red-500 text-red-900 placeholder-red-700 text-sm rounded-lg focus:ring-red-500 dark:bg-gray-700 focus:border-red-500 block w-full p-2.5 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500' : 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'; ?>" placeholder="Nama Lengkap" autofocus autocomplete="off">
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><?= $errorMessage['nama']; ?></p>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="username" value="<?= old('username'); ?>" id="username" class="<?= ($errorMessage['username']) ? 'bg-red-50 border border-red-500 text-red-900 placeholder-red-700 text-sm rounded-lg focus:ring-red-500 dark:bg-gray-700 focus:border-red-500 block w-full p-2.5 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500' : 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'; ?>" placeholder="Username" autofocus autocomplete="off">
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><?= $errorMessage['username']; ?></p>
                    </div>

                    <div>
                        <label for="password" class="block mb-2 text-sm font-medium <?= ($errorMessage['password']) ? 'text-red-700 dark:text-red-500' : 'text-gray-900 dark:text-white'; ?>">Kata Sandi</label>
                    ...
                    <div>
                        <label for="repassword" class="block mb-2 text-sm font-medium <?= ($errorMessage['repassword']) ? 'text-red-700 dark:text-red-500' : 'text-gray-900 dark:text-white'; ?>">Konfirmasi Kata Sandi</label>
                        <input type="password" id="repassword" name="repassword" class="<?= ($errorMessage['repassword']) ? 'bg-red-50 border border-red-500 text-red-900 placeholder-red-700 text-sm rounded-lg focus:ring-red-500 dark:bg-gray-700 focus:border-red-500 block w-full p-2.5 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500' : 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'; ?>" placeholder="Konfirmasi Kata Sandi">
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><?= $errorMessage['repassword']; ?></p>
                    </div>
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Sudah punya akun? <a href="/masuk" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Masuk</a>
                    </p>
                </form>
            </div>
        </div>
